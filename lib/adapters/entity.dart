...
extension StockOperationEntity on StockOperation {
  Map<String, dynamic> toEntity() {
    return {
      ...
      'stock_operation_unity_value': unityValue,
      'stock_operation_unities': unities,
      'stock_operation_taxes': taxes,
      'stock_operation_operation_fee': operationFee,
      'stock_operation_emoluments': emoluments,
      'stock_operation_liquidation_fee': liquidationFee,
      'stock_operation_other_fees': otherFees,
